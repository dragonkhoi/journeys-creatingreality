...
Geo = function Geo( zones ) {
	...
	this.geoSuccess = function geoSuccess( position ) {
		...
		for ( let zone of this.zones ) {
			...
			const distance = Geo.getDistance( position.coords, zone.coords )
...
Geo.getBearing = function getBearing( coords1, coords2 ) {
	...
	// console.log( "returning bearing ", bearing )
...
Geo.getDistance = function getDistance( coords1, coords2 ) {
	// console.log( "starting distance with ", coords1, coords2 )
	// haversine
	...
	// console.log( "returning distance ", distance )
